...
import { getOrder, setRating } from '../../../middleware/rating/rating-client-thunks'
import { getLoadingState, getStatusState, orderToRateState } from '../../../middleware/state-selectors'
...
export default compose(connect(mapStateToProps, mapDispatchToProps))(RatingPage)
