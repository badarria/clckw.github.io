const { findMasters, upsertCustomer, auth, confirmingMail, stayAuth, addNewOrder, ratingRequestMail, getInitState } = require('./home-requests')
...
router.get('/find', validator(masters, 'headers'), dbTryCatch(findMasters))
